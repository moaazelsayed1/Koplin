...
var Password = React8.memo(React8.forwardRef(function(inProps, ref) {
  ...
  var _React$useState3 = React8.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), meterState = _React$useState4[0], setMeterState = _React$useState4[1];
  var _React$useState5 = React8.useState(promptLabel), _React$useState6 = _slicedToArray(_React$useState5, 2), infoTextState = _React$useState6[0], setInfoTextState = _React$useState6[1];
  var _React$useState7 = React8.useState(false), _React$useState8 = _slicedToArray(_React$useState7, 2), focusedState = _React$useState8[0], setFocusedState = _React$useState8[1];
  var _React$useState9 = React8.useState(false), _React$useState10 = _slicedToArray(_React$useState9, 2), unmaskedState = _React$useState10[0], setUnmaskedState = _React$useState10[1];
  var elementRef = React8.useRef(null);
  var overlayRef = React8.useRef(null);
  var inputRef = React8.useRef(props.inputRef);
  var mediumCheckRegExp = React8.useRef(new RegExp(props.mediumRegex));
  var strongCheckRegExp = React8.useRef(new RegExp(props.strongRegex));
  ...
  var createIcon = function createIcon2() {
    if (props.toggleMask) {
      ...
      var content = React8.createElement("i", {
  ...
  var createPanel = function createPanel2() {
    ...
    var content = props.content ? ObjectUtils.getJSXElement(props.content, props) : React8.createElement(React8.Fragment, null, React8.createElement("div", {
    ...
    var panel2 = React8.createElement(CSSTransition2, {
      nodeRef: overlayRef,
  ...
  return React8.createElement("div", {
    ...
    className,
    style: props.style
  }, React8.createElement(InputText, _extends2({
    ref: inputRef,
    id: props.inputId
  }, inputProps, {
    type,
